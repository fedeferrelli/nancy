...
function Hero() {
    return (
        <div className="w-full h-[500px] max-h-[650px]  sm:h-screen shadow-md relative z-10">
  ...
  height: '100%'
            ...
            <div className=" w-full h-full bg-gradient-to-r from-red-800/70 to-blue-900/60 px-4 flex flex-col justify-center items-center">
